            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  // SizedBox(height: 70,),
                  text(text1: 'Register',size: 35,font: "title",
                    fontWeight: FontWeight.w100,
                    color: ColorApp.color2,),
                  text(text1: 'Create your new accout ',size: 15,fontWeight: FontWeight.normal,),
                  Center(
                    child: TextButton(
                      onPressed: () {
                        _openImagePicker();
                  ...
                  Padding(
                    ...
                    child: textfromfilde(hint:'Full Name',
                  ...
                  Padding(
                    padding: const EdgeInsets.only(left: 18.0,right: 18.0,bottom: 18.0,),
                    child: textfromfilde(hint:'Address',
                  ...
                  Padding(
                    ...
                    child: textfromfilde(hint:'Your Phone ',count: 10,
                        ...
                        child: Row(
                          ...
                          children: [
                            defaultButton(
                                onTap: () {
                                  gender="female";
                                  registerCubit.get(context).type_gender("female");
                                },
                                w:140 ,
                                text: "female",
                            ...
                            defaultButton(
                              ...
                              onTap: () { registerCubit.get(context).type_gender("male");
                              gender="female";
                              },
                              text: "male",textColor:registerCubit.get(context).m_gender,
                              color: ColorApp.color4,
                              w: 140,
                            ),
                  ...
                  showError
                    ...
                    child: Row(
                      ...
                      children: [
                        text(
                          text1: 'chose the gender', color: ColorApp.color2,size: 12,fontWeight: FontWeight.w100,
                        ),
                      ],
                    ),
                  )
                    ...
                    child: Center(
                      child: defaultButton(
                          onTap: (){
                            ...
                            {
                              if ((passwordcontroller.text.length > 7 && password1controller.text.length > 7))
                              {
                                setState(() {
                                  passError = false;
                                });
                  ...
                  Row(
                    ...
                    children: [
                      text(text1: "Already have an account?",size: 14,),
                      textButton(text: "Log in", onTap: (){
